...
/// dispensé d'EPS a coefficients 6 et points 80 ; l'élève libre garde les trois matières.
/// </summary>
...
public class ExemptSubjectReportCardDataTests : IAsyncLifetime
{
    ...
    public async Task InitializeAsync()
    {
        ...
        var inscription = NewEnrollment(Eleve, "R-1");
        owner.Enrollments.AddRange(inscription, NewEnrollment(EleveLibre, "R-2"));
        owner.EnrollmentSubjectExemptions.Add(new EnrollmentSubjectExemption
        {
            SchoolId = Ecole, EnrollmentId = inscription.Id, SubjectId = Eps, Reason = "Inaptitude médicale"
        });
    ...
    private static Enrollment NewEnrollment(Guid student, string receipt) => new()
    {
        SchoolId = Ecole, StudentId = student, SchoolYearId = Annee, ClassroomId = Classe,
