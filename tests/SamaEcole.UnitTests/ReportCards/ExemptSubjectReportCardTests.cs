...
public class ExemptSubjectReportCardTests
{
    ...
    /// <summary>Le motif d'une dispense peut être médical : il n'existe sur AUCUN objet de bulletin.</summary>
    [Fact]
    public void The_Reason_Of_An_Exemption_Is_Never_Carried_By_The_Report_Card()
    {
