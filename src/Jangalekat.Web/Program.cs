using System.Text;
using Jangalekat.Application;
using Jangalekat.Infrastructure;
using Jangalekat.Persistence;
using Jangalekat.Web.Middleware;
...
{
    options.SwaggerDoc("v1", new() { Title = "Jangalekat API", Version = "v1" });
});
