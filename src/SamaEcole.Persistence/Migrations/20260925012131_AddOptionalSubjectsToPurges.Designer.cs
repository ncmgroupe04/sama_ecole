...
namespace SamaEcole.Persistence.Migrations
{
    ...
    [Migration("20260925012131_AddOptionalSubjectsToPurges")]
    partial class AddOptionalSubjectsToPurges
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SamaEcole.Domain.Entities.EnrollmentSubjectExemption", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("SchoolId", "EnrollmentId", "SubjectId")
                        .IsUnique()
                        .HasDatabaseName("UX_enrollment_subject_exemptions_key")
                        .HasFilter("NOT \"IsDeleted\"");

                    b.ToTable("enrollment_subject_exemptions", (string)null);
                });
