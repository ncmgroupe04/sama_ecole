# Jangalekat.Application

Logique métier applicative. Dépend uniquement de `Jangalekat.Domain`. Aucune dépendance à EF Core, ASP.NET, ou tout framework d'infrastructure — seulement des interfaces.
