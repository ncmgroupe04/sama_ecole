...
> **Colonne « Coefficient » — valeur EFFECTIVE, mise en page inchangée (Évolution N°4).** Elle imprime le coefficient réellement appliqué à l'élève : surcharge de sa classe, sinon de sa série, sinon celui de la matière. Aucune colonne, aucun libellé ni aucune dimension ne change : seul le nombre affiché peut différer d'un élève de S2 à un élève de L2 pour la même matière. Le total des coefficients et la moyenne pondérée en découlent.
